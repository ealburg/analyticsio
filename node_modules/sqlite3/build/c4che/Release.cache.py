...
CPPPATH_SQLITE3 = ['../deps/sqlite-autoconf-3070800']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/spyderwebtech/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-L../deps/sqlite-autoconf-3070800/.libs', '-lsqlite3', '-Wl,-search_paths_first']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/spyderwebtech/.node_libraries'
PREFIX = '/usr/local'
